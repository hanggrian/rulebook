...
from rulebook_cppcheck.checkers import TrailingNewlineChecker
from .checker_case import CheckerTestCase
from ..asserts import assert_properties


class TestTrailingNewlineChecker(CheckerTestCase):
    CHECKER_CLASS = TrailingNewlineChecker

    def test_rule_properties(self):
        assert_properties(self.CHECKER_CLASS)

    @patch.object(TrailingNewlineChecker, 'report_error')
