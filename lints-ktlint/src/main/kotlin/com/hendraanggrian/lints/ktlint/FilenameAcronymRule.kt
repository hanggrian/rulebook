...
/**
 * [See guide](https://github.com/hendraanggrian/lints/blob/main/rules.md#filename-acronym).
 */
class FilenameAcronymRule : Rule("filename-acronym") {
    ...
    override fun beforeVisitChildNodes(
        ...
        for (i in 0 until fileName.length - 1) {
            if (fileName[i].isUpperCase() && fileName[i + 1].isUpperCase()) {
