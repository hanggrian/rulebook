...
from rulebook_pylint.builtin_function_position_checker import BuiltinFunctionPositionChecker
...
class TestBuiltinFunctionPositionChecker(CheckerTestCase):
    ...
    def test_special_function_not_at_the_function(self):
        ...
        with self.assertAddsMessages(
            msg(BuiltinFunctionPositionChecker.MSG, (3, 4, 15), node1, '__str__'),
            msg(BuiltinFunctionPositionChecker.MSG, (9, 4, 16), node3, '__hash__'),
        ):
            self.checker.visit_functiondef(node1)
            self.checker.visit_functiondef(node2)
            self.checker.visit_functiondef(node3)
