...
class IfElseDenestingChecker(Checker):
    """See wiki: https://github.com/hanggrian/rulebook/wiki/Rules/#if-else-denesting
    """
    MSG_INVERT: str = 'if-else-denesting-invert'
    MSG_LIFT: str = 'if-else-denesting-lift'

    name: str = 'if-else-denesting'
...
def register(linter: 'PyLinter') -> None:
    linter.register_checker(IfElseDenestingChecker(linter))
