...
class StringLiteralQuotingChecker(TokenChecker):
    """See wiki: https://github.com/hanggrian/rulebook/wiki/Rules/#string-literal-quoting
    """
    MSG: str = 'string-literal-quoting'

    name: str = 'string-literal-quoting'
...
def register(linter: 'PyLinter') -> None:
    linter.register_checker(StringLiteralQuotingChecker(linter))
