...
class StringQuotationChecker(RulebookTokenChecker):
    """See wiki: https://github.com/hanggrian/rulebook/wiki/Rules/#string-quotation"""
    MSG_SINGLE: str = 'string-quotation-single'
    MSG_DOUBLE: str = 'string-quotation-double'

    name: str = 'string-quotation'
...
def register(linter: 'PyLinter') -> None:
    linter.register_checker(StringQuotationChecker(linter))
