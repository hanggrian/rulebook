...
/**
 * [See wiki](https://github.com/hanggrian/rulebook/wiki/Rules/#kotlin-property-name-interoperability)
 */
public class KotlinPropertyNameInteroperabilityRule :
    Rule("kotlin-property-name-interoperability") {
    ...
    internal companion object {
        const val MSG = "kotlin.property.name.interoperability"
