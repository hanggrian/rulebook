...
/** [See detail](https://hanggrian.github.io/rulebook/rules/#deprecated-equality) */
public class DeprecatedEqualityRule : RulebookRule(ID) {
    ...
    public companion object {
        public val ID: RuleId = RuleId("${RulebookRuleSet.ID.value}:deprecated-equality")
        private const val MSG = "deprecated.equality"
    }
}
