...
/** [See wiki](https://github.com/hanggrian/rulebook/wiki/Rules/#abstract-class-function-abstraction) */
public class AbstractClassFunctionAbstractionRule : RulebookRule(ID) {
    ...
    internal companion object {
        val ID = RuleId("${RulebookRuleSet.ID.value}:abstract-class-function-abstraction")

        const val MSG = "abstract.class.function.abstraction"
    }
}
