...
/** [See detail](https://hanggrian.github.io/rulebook/rules/#boolean-property-interoperability) */
public class BooleanPropertyInteroperabilityRule : RulebookRule(ID) {
    ...
    public companion object {
        public val ID: RuleId =
            RuleId("${RulebookRuleSet.ID.value}:boolean-property-interoperability")
        private const val MSG = "boolean.property.interoperability"
