...
/**
 * [See wiki](https://github.com/hendraanggrian/rulebook/wiki/AddEmptyLineBeforeTags).
 */
class AddEmptyLineBeforeTagsRule : RulebookRule("add-empty-line-before-tags") {
    internal companion object {
        const val MSG = "add.empty.line.before.tags"
    }
    ...
    override fun beforeVisitChildNodes(
        ...
        val kdocTag = node.getOrNull(KDOC_TAG) ?: return
