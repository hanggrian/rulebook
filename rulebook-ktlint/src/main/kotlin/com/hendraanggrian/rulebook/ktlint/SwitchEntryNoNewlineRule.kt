...
/**
 * [See wiki](https://github.com/hendraanggrian/rulebook/wiki/SwitchEntryNoNewline).
 */
class SwitchEntryNoNewlineRule : RulebookRule("switch-entry-no-newline") {
    internal companion object {
        const val MSG = "switch.entry.no.newline"
    }
