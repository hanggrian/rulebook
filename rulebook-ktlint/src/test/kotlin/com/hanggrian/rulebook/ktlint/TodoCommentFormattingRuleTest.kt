...
import com.hanggrian.rulebook.ktlint.TodoCommentFormattingRule.Companion.MSG_KEYWORD
import com.hanggrian.rulebook.ktlint.TodoCommentFormattingRule.Companion.MSG_SEPARATOR
...
class TodoCommentFormattingRuleTest {
    ...
    @Test
    fun `Rule properties`() = TodoCommentFormattingRule().assertProperties()
