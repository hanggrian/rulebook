...
import com.hanggrian.rulebook.ktlint.GenericsNameAllowingRule.Companion.MSG
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class GenericsNameAllowingRuleTest {
    private val assertThatCode = assertThatRule { GenericsNameAllowingRule() }

    @Test
    fun `Rule properties`() = GenericsNameAllowingRule().assertProperties()
