...
import com.hanggrian.rulebook.ktlint.CaseLineSpacingRule.Companion.MSG_MISSING
...
class CaseLineSpacingRuleTest {
    private val assertThatCode = assertThatRule { CaseLineSpacingRule() }

    @Test
    fun `Rule properties`() = CaseLineSpacingRule().assertProperties()
