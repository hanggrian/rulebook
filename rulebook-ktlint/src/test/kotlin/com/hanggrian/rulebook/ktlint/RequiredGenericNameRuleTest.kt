...
class RequiredGenericNameRuleTest {
    private val assertThatCode = assertThatRule { RequiredGenericNameRule() }

    @Test
    fun `Rule properties`() = RequiredGenericNameRule().assertProperties()
