...
import com.hanggrian.rulebook.ktlint.IfElseDenestingRule.Companion.MSG_INVERT
import com.hanggrian.rulebook.ktlint.IfElseDenestingRule.Companion.MSG_LIFT
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class IfElseDenestingRuleTest {
    private val assertThatCode = assertThatRule { IfElseDenestingRule() }

    @Test
    fun `Rule properties`() = IfElseDenestingRule().assertProperties()
