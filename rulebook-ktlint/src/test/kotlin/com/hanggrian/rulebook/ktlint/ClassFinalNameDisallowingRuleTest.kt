...
import com.hanggrian.rulebook.ktlint.ClassFinalNameDisallowingRule.Companion.MSG_ALL
import com.hanggrian.rulebook.ktlint.ClassFinalNameDisallowingRule.Companion.MSG_UTIL
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class ClassFinalNameDisallowingRuleTest {
    private val assertThatCode = assertThatRule { ClassFinalNameDisallowingRule() }

    @Test
    fun `Rule properties`() = ClassFinalNameDisallowingRule().assertProperties()
