...
import com.hanggrian.rulebook.ktlint.PropertyNameInteroperabilityRule.Companion.MSG
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class PropertyNameInteroperabilityRuleTest {
    private val assertThatCode = assertThatRule { PropertyNameInteroperabilityRule() }

    @Test
    fun `Rule properties`() = PropertyNameInteroperabilityRule().assertProperties()
