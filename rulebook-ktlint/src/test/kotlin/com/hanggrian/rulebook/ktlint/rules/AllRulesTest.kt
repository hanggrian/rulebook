...
class AllRulesTest {
    ...
    fun org_jetbrains_exposed_dsl_Table() {
        assertThatCodeAll(
            ...
            LintViolation(626, 10, "Use single uppercase letter.", false),
            ...
            LintViolation(690, 10, "Use single uppercase letter.", false),
            LintViolation(703, 10, "Use single uppercase letter.", false),
