...
import com.hanggrian.rulebook.ktlint.IdentifierNameDisallowingRule.Companion.MSG
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class IdentifierNameDisallowingRuleTest {
    private val assertThatCode = assertThatRule { IdentifierNameDisallowingRule() }

    @Test
    fun `Rule properties`() = IdentifierNameDisallowingRule().assertProperties()
