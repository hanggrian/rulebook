...
import com.hanggrian.rulebook.ktlint.KotlinTypePriorityRule.Companion.MSG
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class KotlinTypePriorityRuleTest {
    private val assertThatCode = assertThatRule { KotlinTypePriorityRule() }

    @Test
    fun `Rule properties`() = KotlinTypePriorityRule().assertProperties()
