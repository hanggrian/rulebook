...
class LonelyConfigurationRuleTest : RuleTest() {
    private val assertThatCode = assertThatRule { LonelyConfigurationRule() }

    @Test
    fun `Rule properties`() = LonelyConfigurationRule().assertProperties()
