...
import com.hanggrian.rulebook.ktlint.VariableNameDisallowingRule.Companion.MSG
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class VariableNameDisallowingRuleTest {
    private val assertThatCode = assertThatRule { VariableNameDisallowingRule() }

    @Test
    fun `Rule properties`() = VariableNameDisallowingRule().assertProperties()
