...
import com.hanggrian.rulebook.ktlint.KotlinPropertyNameInteroperabilityRule.Companion.MSG
import com.hanggrian.rulebook.ktlint.internals.Messages
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class KotlinPropertyNameInteroperabilityRuleTest {
    private val assertThatCode = assertThatRule { KotlinPropertyNameInteroperabilityRule() }

    @Test
    fun `Rule properties`() = KotlinPropertyNameInteroperabilityRule().assertProperties()
