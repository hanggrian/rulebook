...
class BooleanPropertyInteroperabilityRuleTest : RuleTest() {
    private val assertThatCode = assertThatRule { BooleanPropertyInteroperabilityRule() }

    @Test
    fun `Rule properties`() = BooleanPropertyInteroperabilityRule().assertProperties()
