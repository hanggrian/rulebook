...
class AddEmptyLineInClassRuleTest {
    ...
    fun `Class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MyClass")
    )
    ...
    fun `Annotation class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MyAnnotation")
    )
    ...
    fun `Data class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MyData")
    )
    ...
    fun `Enum class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MyEnum")
    )
    ...
    fun `Sealed class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MySealed")
    )
    ...
    fun `Interface multiple-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MyInterface")
    )
    ...
    fun `Object multiple-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(AddEmptyLineInClassRule.MSG, "MyObject")
    )
    ...
    fun `Companion object multiple-line declaration`() = assertThatCode(
        ...
        4,
        9,
        Messages.get(AddEmptyLineInClassRule.MSG, "Companion object")
    )
