...
class FunctionReturnTypeRuleTest {
    ...
    fun `Expression function`() = assertThatCode(
        ...
        LintViolation(1, 25, Messages.get(FunctionReturnTypeRule.MSG_EXPR, "expressionFunction")),
        LintViolation(3, 29, Messages.get(FunctionReturnTypeRule.MSG_EXPR, "expressionFunction"))
    )
    ...
    fun `Getter function`() = assertThatCode(
        ...
        LintViolation(1, 21, Messages.get(FunctionReturnTypeRule.MSG_PROP, "propertyAccessor")),
        LintViolation(3, 25, Messages.get(FunctionReturnTypeRule.MSG_PROP, "propertyAccessor"))
    )
