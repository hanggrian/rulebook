...
class ClassBodyStartingNewlineRuleTest {
    private val assertThatCode = assertThatRule { ClassBodyStartingNewlineRule() }
    ...
    fun `Class single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MyClass")
    )
    ...
    fun `Class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MyClass")
    )
    ...
    fun `Annotation class single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MyAnnotation")
    )
    ...
    fun `Annotation class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MyAnnotation")
    )
    ...
    fun `Data class single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MyData")
    )
    ...
    fun `Data class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MyData")
    )
    ...
    fun `Enum class single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MyEnum")
    )
    ...
    fun `Enum class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MyEnum")
    )
    ...
    fun `Sealed class single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MySealed")
    )
    ...
    fun `Sealed class multiple-line declaration`() = assertThatCode(
        ...
        4,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MySealed")
    )
    ...
    fun `Interface single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MyInterface")
    )
    ...
    fun `Interface multiple-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MyInterface")
    )
    ...
    fun `Object single-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "MyObject")
    )
    ...
    fun `Object multiple-line declaration`() = assertThatCode(
        ...
        3,
        5,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "MyObject")
    )
    ...
    fun `Companion object single-line declaration`() = assertThatCode(
        ...
        4,
        9,
        Messages.get(ClassBodyStartingNewlineRule.MSG_SINGLE, "Companion object")
    )
    ...
    fun `Companion object multiple-line declaration`() = assertThatCode(
        ...
        4,
        9,
        Messages.get(ClassBodyStartingNewlineRule.MSG_MULTIPLE, "Companion object")
    )
