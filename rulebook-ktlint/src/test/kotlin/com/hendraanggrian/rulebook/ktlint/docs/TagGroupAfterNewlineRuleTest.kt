...
class TagGroupAfterNewlineRuleTest {
    private val assertThatCode = assertThatRule { TagGroupAfterNewlineRule() }
    ...
    fun `Missing empty line from summary`() = assertThatCode(
        ...
        LintViolation(3, 4, Messages[TagGroupAfterNewlineRule.MSG]),
        LintViolation(10, 4, Messages[TagGroupAfterNewlineRule.MSG]),
        LintViolation(17, 4, Messages[TagGroupAfterNewlineRule.MSG])
    )
}
