...
class UseAbstractCollectionRuleTest {
    ...
    fun `Use explicit collections as function parameter`() = assertThatCode(
        ...
        LintViolation(2, 25, Messages[UseAbstractCollectionRule.MSG_SET]),
        LintViolation(3, 25, Messages[UseAbstractCollectionRule.MSG_SET]),
        LintViolation(4, 25, Messages[UseAbstractCollectionRule.MSG_MAP]),
        LintViolation(5, 25, Messages[UseAbstractCollectionRule.MSG_MAP])
    )
    ...
    fun `Use explicit collections as constructor parameter`() = assertThatCode(
        ...
        LintViolation(1, 31, Messages[UseAbstractCollectionRule.MSG_LIST]),
        LintViolation(2, 29, Messages[UseAbstractCollectionRule.MSG_SET]),
        LintViolation(3, 29, Messages[UseAbstractCollectionRule.MSG_SET]),
        LintViolation(4, 29, Messages[UseAbstractCollectionRule.MSG_MAP]),
        LintViolation(5, 29, Messages[UseAbstractCollectionRule.MSG_MAP])
    )
    ...
    fun `Using explicit collection as secondary constructor parameter`() = assertThatCode(
        ...
        LintViolation(2, 39, Messages[UseAbstractCollectionRule.MSG_MAP])
    )
