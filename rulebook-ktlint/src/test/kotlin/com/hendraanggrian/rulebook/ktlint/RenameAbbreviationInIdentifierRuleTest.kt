...
import com.hendraanggrian.rulebook.ktlint.RenameAbbreviationInIdentifierRule.Companion.MSG
import com.pinterest.ktlint.test.KtLintAssertThat.Companion.assertThatRule
import com.pinterest.ktlint.test.LintViolation
import kotlin.test.Test

class RenameAbbreviationInIdentifierRuleTest {
    private val assertThatCode = assertThatRule { RenameAbbreviationInIdentifierRule() }

    @Test
    fun `Class names with lowercase abbreviation`() = assertThatCode(
        """
        class MySqlClass
    ...
    @Test
    fun `Class names with uppercase abbreviation`() = assertThatCode(
        """
        class MySQLClass
        annotation class MySQLAnnotationClass
        data class MySQLDataClass
    ...
    @Test
    fun `Property names with lowercase abbreviation`() = assertThatCode(
        """
    ...
    @Test
    fun `Property names with uppercase abbreviation`() = assertThatCode(
        """
        val globalPROPERTY = 1
    ...
    @Test
    fun `Function names with lowercase abbreviation`() = assertThatCode(
        """
        fun myFunction() {}
        """.trimIndent()
    ).hasNoLintViolations()
    ...
    @Test
    fun `Function names with uppercase abbreviation`() = assertThatCode(
        """
        fun myFUNCTION() {}
        """.trimIndent()
    ...
    @Test
    fun `Parameter names with lowercase abbreviation`() = assertThatCode(
        """
    ...
    @Test
    fun `Parameter names with uppercase abbreviation`() = assertThatCode(
        """
        class Foo(myPARAMETER: Int)
        fun bar(myPARAMETER: Int) {}
        """.trimIndent()
    ...
    @Test
    fun `File abbreviation`() = assertThatCode("")
