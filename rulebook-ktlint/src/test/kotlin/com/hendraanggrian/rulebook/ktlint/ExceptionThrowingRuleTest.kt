...
class ExceptionThrowingRuleTest {
    ...
    fun `Throw superclass exceptions`() =
        assertThatCode(
            ...
            LintViolation(2, 11, Messages[ExceptionThrowingRule.MSG]),
            LintViolation(5, 11, Messages[ExceptionThrowingRule.MSG]),
            LintViolation(8, 11, Messages[ExceptionThrowingRule.MSG]),
        )
