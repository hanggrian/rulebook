...
/**
 * [See wiki](https://github.com/hendraanggrian/rulebook/wiki/Rules#add-space-before-comment).
 */
public class AddSpaceBeforeCommentCheck : RulebookCheck() {
    ...
    internal companion object {
        const val MSG = "add.space.before.comment"
    }
}
