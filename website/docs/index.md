...
Deprecated equality[^kotlin-structural-equality] | | | :material-check-all:{ .lg }
...
<span class="material-symbols-outlined lg middle">terminal</span> **Scripting group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
Complicated boolean comparison[^jetbrains-simplify-boolean-with-constants] | [:material-information-outline:{ .lg title="SimplifyBooleanExpression" }](https://checkstyle.sourceforge.io/checks/coding/simplifybooleanexpression.html) | [:material-information-outline:{ .lg title="UnnecessaryBooleanExpression" }](https://codenarc.org/codenarc-rules-unnecessary.html#unnecessarybooleanexpression-rule) | :material-check-all:{ .lg } | :material-help:{ .lg } | [:material-information-outline:{ .lg title="singleton-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/singleton-comparison.html) | :material-help:{ .lg } | :material-help:{ .lg }
Complicated size comparison[^jetbrains-size-replaceable-by-is-empty] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-help:{ .lg } | [:material-information-outline:{ .lg title="use-implicit-booleaness-not-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/use-implicit-booleaness-not-comparison.html) [:material-information-outline:{ .lg title="use-implicit-booleaness-not-len" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/use-implicit-booleaness-not-len.html) | :material-help:{ .lg } | :material-help:{ .lg }
