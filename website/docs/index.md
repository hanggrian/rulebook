...
Redundant qualifier[^jetbrains-redundant-qualifier-name] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | | :material-close:{ .lg }
...
Lowercase Hex[^google-capitalization] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
...
Unnecessary scope[^common-use-named-object-directly] | | :material-check-all:{ .lg } | :material-check-all:{ .lg }
...
Complicated boolean expression[^common-simple-comparison] | [:material-information-outline:{ .lg title="SimplifyBooleanExpression" }](https://checkstyle.sourceforge.io/checks/coding/simplifybooleanexpression.html) | [:material-information-outline:{ .lg title="UnnecessaryBooleanExpression" }](https://codenarc.org/codenarc-rules-unnecessary.html#unnecessarybooleanexpression-rule) | :material-help:{ .lg } | :material-help:{ .lg } | [:material-information-outline:{ .lg title="singleton-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/singleton-comparison.html) | :material-help:{ .lg } | :material-help:{ .lg }
Complicated empty comparison[^common-simple-comparison] | | | | | [:material-information-outline:{ .lg title="use-implicit-booleaness-not-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/use-implicit-booleaness-not-comparison.html) [:material-information-outline:{ .lg title="use-implicit-booleaness-not-len" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/use-implicit-booleaness-not-len.html) | :material-help:{ .lg } | :material-help:{ .lg }
...
Unnecessary continue[^jetbrains-unnecessary-continue-statement] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-help:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
Unnecessary return[^jetbrains-unnecessary-return-statement] | :material-check-all:{ .lg } | :material-close:{ .lg } | :material-check-all:{ .lg } | :material-help:{ .lg } | [:material-information-outline:{ .lg title="useless-return" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/useless-return.html) | [:material-information-outline:{ .lg title="no-useless-return" }](https://eslint.org/docs/latest/rules/no-useless-return/) | [:material-information-outline:{ .lg title="no-useless-return" }](https://eslint.org/docs/latest/rules/no-useless-return/)
...
[^common-simple-comparison]: [Simple comparison](rationales/index.md#simple-comparison)
...
[^jetbrains-invert-if]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Invert if statement to reduce nesting :material-open-in-new:](https://www.jetbrains.com/help/resharper/InvertIf.html)
...
[^jetbrains-redundant-qualifier-name]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Redundant name qualifier :material-open-in-new:](https://www.jetbrains.com/help/resharper/RedundantNameQualifier.html)
...
[^jetbrains-unnecessary-continue-statement]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Unnecessary continue statement :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/UnnecessaryContinue.html)
