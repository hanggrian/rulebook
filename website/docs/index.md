...
<span class="material-symbols-outlined middle">data_object</span> **Declaring group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
Deprecated type[^kotlin-mapped-types] | | | :material-check-all:{ .lg } | | [:material-information-outline:{ .lg title="deprecated-typing-alias" }](https://pylint.pycqa.org/en/latest/user_guide/messages/warning/deprecated-typing-alias.html) | | [:material-information-outline:{ .lg title="no-restricted-types" }](https://typescript-eslint.io/rules/no-restricted-types/)
...
Internal error[^oracle-throwing] | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="ExceptionExtendsError" }](https://codenarc.org/codenarc-rules-exceptions.html#exceptionextendserror-rule) [:material-information-outline:{ .lg title="ExceptionExtendsThrowable" }](https://codenarc.org/codenarc-rules-exceptions.html#exceptionextendsthrowable-rule) | :material-check-all:{ .lg } | | :material-check-all:{ .lg }
...
Lowercase Hexadecimal[^google-capitalization] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
Lowercase i[^groovy-number-type-suffixes] | | :material-check-all:{ .lg }
Missing inline in contract[^kotlin-kotlin-contracts] | | | :material-check-all:{ .lg }
Missing private constructor[^common-hide-utility-class-instance] | [:material-information-outline:{ .lg title="HideUtilityClassConstructor" }](https://checkstyle.sourceforge.io/checks/design/hideutilityclassconstructor.html) | :material-check-all:{ .lg }
Redundant qualifier[^jetbrains-redundant-name-qualifier] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | | :material-close:{ .lg }
...
Unnecessary abstract[^common-abstract-class-require-abstract-method] | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="AbstractClassWithoutAbstractMethod" }](https://codenarc.org/codenarc-rules-design.html#abstractclasswithoutabstractmethod-rule) | :material-check-all:{ .lg } | | :material-check-all:{ .lg } | | :material-check-all:{ .lg }
...
<span class="material-symbols-outlined middle">regular_expression</span> **Expressing group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
Complicated boolean equality[^jetbrains-simplify-boolean-with-constants] | [:material-information-outline:{ .lg title="SimplifyBooleanExpression" }](https://checkstyle.sourceforge.io/checks/coding/simplifybooleanexpression.html) | [:material-information-outline:{ .lg title="UnnecessaryBooleanExpression" }](https://codenarc.org/codenarc-rules-unnecessary.html#unnecessarybooleanexpression-rule) | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="redundantCondition" }](https://cppcheck.sourceforge.io/devinfo/doxyoutput/classCheckStl.html#abe03476dc6368ba6c20ad90d7eb967a8) | [:material-information-outline:{ .lg title="singleton-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/singleton-comparison.html) | | [:material-information-outline:{ .lg title="no-unnecessary-boolean-literal-compare" }](https://typescript-eslint.io/rules/no-unnecessary-boolean-literal-compare/)
Complicated size equality[^jetbrains-size-replaceable-by-is-empty] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | | [:material-information-outline:{ .lg title="use-implicit-booleaness-not-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/use-implicit-booleaness-not-comparison.html) [:material-information-outline:{ .lg title="use-implicit-booleaness-not-len" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/use-implicit-booleaness-not-len.html) | [:material-information-outline:{ .lg title="no-restricted-syntax" }](https://eslint.org/docs/latest/rules/no-restricted-syntax/) | [:material-information-outline:{ .lg title="no-restricted-syntax" }](https://eslint.org/docs/latest/rules/no-restricted-syntax/)
Confusing predicate[^kotlin-filter-by-predicate] | | | :material-check-all:{ .lg }
Deprecated identity[^kotlin-structural-equality] | | | :material-check-all:{ .lg }
Redundant equality[^jetbrains-object-equals-can-be-equality] | | :material-check-all:{ .lg } | | | [:material-information-outline:{ .lg title="singleton-comparison" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/singleton-comparison.html) | [:material-information-outline:{ .lg title="no-restricted-syntax" }](https://eslint.org/docs/latest/rules/no-restricted-syntax/) | [:material-information-outline:{ .lg title="no-restricted-syntax" }](https://eslint.org/docs/latest/rules/no-restricted-syntax/)
Redundant equals[^jetbrains-object-equals-can-be-equality] | | [:material-information-outline:{ .lg title="ExplicitCallToEqualsMethod" }](https://codenarc.org/codenarc-rules-groovyism.html#explicitcalltoequalsmethod-rule)
<span class="material-symbols-outlined middle">draft</span> **Formatting group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
<span class="material-symbols-outlined middle">label</span> **Naming group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
Boolean property interoperability[^kotlin-properties] | | | :material-check-all:{ .lg }
...
<span class="material-symbols-outlined middle">swap_vert</span> **Ordering group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
Import order[^google-import-ordering-and-spacing] | [:material-information-outline:{ .lg title="CustomImportOrder" }](https://checkstyle.sourceforge.io/checks/imports/customimportorder.html) | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="import-ordering" }](https://pinterest.github.io/ktlint/latest/rules/standard/#import-ordering) | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="wrong-import-order" }](https://pylint.pycqa.org/en/latest/user_guide/messages/convention/wrong-import-order.html) | [:material-information-outline:{ .lg title="order" }](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/order.md) | [:material-information-outline:{ .lg title="order" }](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/order.md)
...
Named import order[^common-sort-named-imports] | | | | | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="sort-imports" }](https://eslint.org/docs/latest/rules/sort-imports/) | [:material-information-outline:{ .lg title="sort-imports" }](https://eslint.org/docs/latest/rules/sort-imports/)
...
<span class="material-symbols-outlined middle">terminal</span> **Scripting group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
Decentralized dependency[^gradle-use-version-catalogs] | | :material-check-all:{ .lg } | :material-check-all:{ .lg }
Eager API[^gradle-eager-apis-to-avoid] | | :material-check-all:{ .lg } | :material-check-all:{ .lg }
Lonely configuration[^common-use-named-object-directly] | | :material-check-all:{ .lg } | :material-check-all:{ .lg }
Root project name[^gradle-name-your-root-project] | | :material-check-all:{ .lg } | :material-check-all:{ .lg }
Script file name[^gradle-naming-recommendations] | | :material-check-all:{ .lg } | :material-check-all:{ .lg }
<span class="material-symbols-outlined middle">format_letter_spacing_2</span> **Spacing group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
<span class="material-symbols-outlined middle">code_blocks</span> **Stating group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
Lonely case[^jetbrains-switch-statement-with-too-few-branches] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="no-restricted-syntax" }](https://eslint.org/docs/latest/rules/no-restricted-syntax/) | [:material-information-outline:{ .lg title="no-restricted-syntax" }](https://eslint.org/docs/latest/rules/no-restricted-syntax/)
Lonely if[^common-use-else-if] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-help:{ .lg } | [:material-information-outline:{ .lg title="else-if-used" }](https://pylint.readthedocs.io/en/stable/user_guide/messages/refactor/else-if-used.html) | [:material-information-outline:{ .lg title="no-lonely-if" }](https://eslint.org/docs/latest/rules/no-lonely-if/) | [:material-information-outline:{ .lg title="no-lonely-if" }](https://eslint.org/docs/latest/rules/no-lonely-if/)
...
Nested if-else[^jetbrains-invert-if] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-help:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
Redundant default[^jetbrains-redundant-if-else-block] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
Redundant else[^jetbrains-redundant-if-else-block] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="no-else-break" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/no-else-break.html) [:material-information-outline:{ .lg title="no-else-continue" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/no-else-continue.html) [:material-information-outline:{ .lg title="no-else-raise" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/no-else-raise.html) [:material-information-outline:{ .lg title="no-else-return" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/no-else-return.html) | :material-check-all:{ .lg } | :material-check:{ .lg }
Redundant if[^jetbrains-redundant-if-statement] | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="UnnecessaryIfStatement" }](https://codenarc.org/codenarc-rules-unnecessary.html#unnecessaryifstatement-rule) | :material-check-all:{ .lg } | :material-help:{ .lg } | [:material-information-outline:{ .lg title="simplifiable-if-statement" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/simplifiable-if-statement.html) | :material-check-all:{ .lg } | :material-check:{ .lg }
...
Unnecessary continue[^jetbrains-unnecessary-continue] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="redundantContinue" }](https://github.com/danmar/cppcheck/blob/main/lib/checkother.cpp) | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
Unnecessary return[^jetbrains-unnecessary-return-statement] | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="useless-return" }](https://pylint.pycqa.org/en/latest/user_guide/messages/refactor/useless-return.html) | [:material-information-outline:{ .lg title="no-useless-return" }](https://eslint.org/docs/latest/rules/no-useless-return/) | [:material-information-outline:{ .lg title="no-useless-return" }](https://eslint.org/docs/latest/rules/no-useless-return/)
<span class="material-symbols-outlined middle">format_letter_spacing_standard</span> **Trimming group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
Unnecessary initial blank line[^google-source-file-structure] | :material-check-all:{ .lg } | [:material-information-outline:{ .lg title="BlankLineBeforePackage" }](https://codenarc.org/codenarc-rules-formatting.html#blanklinebeforepackage-rule) | :material-check-all:{ .lg } | :material-close:{ .lg } | :material-check-all:{ .lg } | :material-check-all:{ .lg } | :material-check:{ .lg }
<span class="material-symbols-outlined middle">format_text_wrap</span> **Wrapping group** | **Java** | **Groovy** | **Kotlin** | **C/C++** | **Python** | **JavaScript** | **TypeScript**
...
[^common-sort-named-imports]: [Sort named imports](rationales/index.md#sort-named-imports)
...
[^common-use-else-if]: [Use else-if](rationales/index.md#use-else-if)
[^common-use-named-object-directly]: [Use named object directly](rationales/index.md#use-named-object-directly)
...
[^editorconfig-file-format-details]: :simple-editorconfig:{ #light .lg .middle } [EditorConfig: File format details :material-open-in-new:](https://editorconfig.org/#file-format-details)
[^google-blocks-k-r-style]: :simple-google:{ #google .lg .middle } [Google: Nonempty blocks: K & R style :material-open-in-new:](https://google.github.io/styleguide/javaguide.html#s4.1.2-blocks-k-r-style)
...
[^google-capitalization]: :simple-google:{ #google .lg .middle } [Google: Capitalization :material-open-in-new:](https://google.github.io/styleguide/htmlcssguide.html#Capitalization)
...
[^google-import-statements]: :simple-google:{ #google .lg .middle } [Google: Imports :material-open-in-new:](https://google.github.io/styleguide/javaguide.html#s3.3-import-statements)
...
[^gradle-use-version-catalogs]: :simple-gradle:{ #gradle .lg .middle } [Gradle: Use version catalogs to centralize dependency versions :material-open-in-new:](https://docs.gradle.org/current/userguide/best_practices_dependencies.html#use_version_catalogs)
[^gradle-eager-apis-to-avoid]: :simple-gradle:{ #gradle .lg .middle } [Gradle: Eager APIs to avoid :material-open-in-new:](https://docs.gradle.org/current/userguide/task_configuration_avoidance.html#eager_apis_to_avoid)
[^gradle-name-your-root-project]: :simple-gradle:{ #gradle .lg .middle } [Gradle: Name your root project :material-open-in-new:](https://docs.gradle.org/current/userguide/best_practices_general.html#name_your_root_project)
[^gradle-naming-recommendations]: :simple-gradle:{ #gradle .lg .middle } [Gradle: Naming recommendations :material-open-in-new:](https://docs.gradle.org/current/userguide/multi_project_builds.html#sec:naming_recommendations)
[^groovy-number-type-suffixes]: :simple-apachegroovy:{ #groovy .lg .middle } [Groovy: Number type suffixes :material-open-in-new:](https://groovy-lang.org/syntax.html#_number_type_suffixes)
[^jetbrains-invert-if]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Invert 'if' statement to reduce nesting :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/InvertIf.html)
[^jetbrains-object-equals-can-be-equality]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Java
'equals()' call can be replaced with '=='﻿ :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/ObjectEqualsCanBeEquality.html)
[^jetbrains-redundant-if-statement]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Redundant 'if' statement :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/RedundantIfStatement.html)
[^jetbrains-redundant-if-else-block]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Redundant 'else' keyword :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/RedundantIfElseBlock.html)
[^jetbrains-redundant-name-qualifier]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Redundant name qualifier :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/RedundantNameQualifier.html)
[^jetbrains-simplify-boolean-with-constants]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Boolean expression can be simplified :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/SimplifyBooleanWithConstants.html)
[^jetbrains-size-replaceable-by-is-empty]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: 'size() == 0' can be replaced with 'isEmpty()' :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/SizeReplaceableByIsEmpty.html)
...
[^jetbrains-unnecessary-continue]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Unnecessary 'continue' statement :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/UnnecessaryContinue.html)
[^jetbrains-unnecessary-return-statement]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Unnecessary 'return' statement :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/UnnecessaryReturnStatement.html)
[^jetbrains-unused-import]: :simple-jetbrains:{ #dark .lg .middle } [JetBrains: Unused import directive :material-open-in-new:](https://www.jetbrains.com/help/inspectopedia/UnusedImport.html)
...
[^openjdk-feedback]: :simple-openjdk:{ #openjdk .lg .middle } [OpenJDK: Summary of feedback :material-open-in-new:](https://cr.openjdk.org/~alundblad/styleguide/feedback.html)
