...
describe('AssignmentWrapTest', () => {
    ...
    it('Multiline assignment with breaking assignee', () =>
        assertThat(
            `
            function foo() {
                const bar =
    ...
    it('Multiline assignment with non-breaking assignee', () =>
        assertThat(
            `
            function foo() {
                const bar = 1 +
    ...
    it('Multiline variable but single-line value', () =>
        assertThat(
            `
            function foo(bar) {
                bar
    ...
    it('Allow comments after assign operator', () =>
        assertThat(
            `
            function foo() {
                const bar =
    ...
    it('Skip collection initializers', () =>
        assertThat(
            `
            function foo() {
                const bar = [
