...
/**
 * [See wiki](https://github.com/hendraanggrian/rulebook/wiki/Rules#acronym-capitalization).
 */
public class AcronymCapitalizationRule : RulebookRule() {
    public override fun getName(): String = "AcronymCapitalization"

    public override fun getAstVisitorClass(): Class<*> = AcronymCapitalizationVisitor::class.java
}

public class AcronymCapitalizationVisitor : AbstractAstVisitor() {
    ...
    internal companion object {
        const val MSG = "acronym.capitalization"
