...
import com.hendraanggrian.rulebook.codenarc.RenameMeaninglessWordNarc
import com.hendraanggrian.rulebook.codenarc.RenameMeaninglessWordVisitor.Companion.MSG_PREFIX
import com.hendraanggrian.rulebook.codenarc.RenameMeaninglessWordVisitor.Companion.MSG_SUFFIX
import com.hendraanggrian.rulebook.codenarc.internals.Messages
import org.codenarc.rule.AbstractRuleTestCase
import kotlin.test.Test
import kotlin.test.assertEquals

class RenameMeaninglessWordNarcTest : AbstractRuleTestCase<RenameMeaninglessWordNarc>() {
    override fun createRule(): RenameMeaninglessWordNarc = RenameMeaninglessWordNarc()

    @Test
    fun `Rule properties`() {
        assertEquals(3, rule.priority)
        assertEquals("RenameMeaninglessWord", rule.name)
    }
