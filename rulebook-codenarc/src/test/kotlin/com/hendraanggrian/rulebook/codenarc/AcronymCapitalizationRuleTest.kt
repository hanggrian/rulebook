...
import com.hendraanggrian.rulebook.codenarc.AcronymCapitalizationVisitor.Companion.MSG
import com.hendraanggrian.rulebook.codenarc.internals.Messages
import org.codenarc.rule.AbstractRuleTestCase
import kotlin.test.Test
import kotlin.test.assertEquals

class AcronymCapitalizationRuleTest :
    AbstractRuleTestCase<AcronymCapitalizationRule>() {
    override fun createRule() = AcronymCapitalizationRule()

    @Test
    fun `Rule properties`() {
        assertEquals(3, rule.priority)
        assertEquals("AcronymCapitalization", rule.name)
    }
