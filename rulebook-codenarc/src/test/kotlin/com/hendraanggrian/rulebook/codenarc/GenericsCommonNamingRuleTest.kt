...
import com.hendraanggrian.rulebook.codenarc.GenericsCommonNamingVisitor.Companion.MSG
import com.hendraanggrian.rulebook.codenarc.internals.Messages
import org.codenarc.rule.AbstractRuleTestCase
import kotlin.test.Test
import kotlin.test.assertEquals

class GenericsCommonNamingRuleTest : AbstractRuleTestCase<GenericsCommonNamingRule>() {
    override fun createRule() = GenericsCommonNamingRule()

    @Test
    fun `Rule properties`() {
        assertEquals(3, rule.priority)
        assertEquals("GenericsCommonNaming", rule.name)
    }
