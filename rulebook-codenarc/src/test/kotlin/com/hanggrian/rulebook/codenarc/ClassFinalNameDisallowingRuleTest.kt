...
import com.hanggrian.rulebook.codenarc.ClassFinalNameDisallowingRule.Companion.MSG_ALL
import com.hanggrian.rulebook.codenarc.ClassFinalNameDisallowingRule.Companion.MSG_UTIL
import com.hanggrian.rulebook.codenarc.internals.Messages
import org.codenarc.rule.AbstractRuleTestCase
import kotlin.test.Test
import kotlin.test.assertIs

class ClassFinalNameDisallowingRuleTest : AbstractRuleTestCase<ClassFinalNameDisallowingRule>() {
    override fun createRule() = ClassFinalNameDisallowingRule()

    @Test
    fun `Rule properties`() {
        rule.assertProperties()

        assertIs<ClassFinalNameDisallowingRule.Visitor>(rule.astVisitor)

        val rule = ClassFinalNameDisallowingRule()
