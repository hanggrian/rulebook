...
class LonelyConfigurationRuleTest : RuleTest<LonelyConfigurationRule>() {
    override fun createRule() = LonelyConfigurationRule()

    @Test
    fun `Rule properties`() {
        rule.assertProperties()
        assertIs<LonelyConfigurationVisitor>(rule.astVisitor)
    }
