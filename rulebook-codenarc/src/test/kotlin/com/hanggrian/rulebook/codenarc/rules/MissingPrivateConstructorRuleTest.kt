...
class MissingPrivateConstructorRuleTest : AbstractRuleTestCase<MissingPrivateConstructorRule>() {
    override fun createRule() = MissingPrivateConstructorRule()

    @Test
    fun `Rule properties`() {
        rule.assertProperties()
        assertIs<MissingPrivateConstructorVisitor>(rule.astVisitor)
    }
